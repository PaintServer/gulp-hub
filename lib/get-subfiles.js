...
module.exports = function(filelist) {
    ...
    filelist.forEach(function (file) {
        ...
        // a subfile's unique name is just its relative path with the
        // gulpfile path removed
        subfile.uniqueName = subfile.relativePath.replace(/\/gulpfile(\.babel)?\.js/i, '');
        subfile.uniqueName = subfile.uniqueName.replace(/gulpfile\.([^\.]+)\.js/i, '$1');
